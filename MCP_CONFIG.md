...
- **Root directory**: /c/Users/chenkuansk/work/rootsApp
- **Server command**:
```bash
npx @modelcontextprotocol/server-filesystem --path "/c/Users/chenkuansk/work/rootsApp"
```

## 2. GitHub MCP (optional)
- **Purpose**: Efficient issue management, pull request creation, and repository analysis
- **Repository**: https://github.com/kuanhc96/roots-app.git
...
```
claude mcp add github --transport http "https://github.com/kuanhc96/roots-app.git"
```
...
- **Server command**:
```bash
npx @modelcontextprotocol/server-git --path "/c/Users/chenkuansk/work/rootsApp"
```
