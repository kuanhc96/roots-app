...
class LoginIntegrationTest extends IntegrationTestBase {
    ...
    class MfaDisabled_EmailVerified_PasswordChangeNotRequired {
        ...
        @Test
        void login_completesAuthorizationCodeFlow_withPkceClient() throws Exception {
            String codeVerifier = generateCodeVerifier();
            String codeChallenge = toS256CodeChallenge(codeVerifier);

            HttpResponse<String> authorizeResponse = authServerClient.startOAuth2AuthorizationFlowWithPKCE(
                    "WEB_CLIENT_PKCE",
                    redirectUri,
            ...
            TokenResponse tokens = oAuth2Client.getAuthorizationGrantTokenWithPKCE(
                    code,
                    "WEB_CLIENT_PKCE",
                    webClientSecret,
                    redirectUri,
